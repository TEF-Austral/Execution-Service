...
@Service
class PrintScriptFormatterService : LanguageFormatterService {
    private val log = org.slf4j.LoggerFactory.getLogger(PrintScriptFormatterService::class.java)
    ...
    override fun format(
        ...
        println("Formatter Config: $config")
